class AddTeamsToTeam < ActiveRecord::Migration
  def up
	...
	Team.create :name => 'Clemson', :image => '/images/clemson_logo.jpg', :id => 61
	Team.create :name => 'Michigan', :image => '/images/michigan_logo.jpg', :id => 62
	Team.create :name => 'Oklahoma', :image => '/images/oklahoma_logo.jpg', :id => 63
	Team.create :name => 'Morgan State', :image => '/images/morganst_logo.jpg', :id => 64
  end
