class FixTeamIdsInGame < ActiveRecord::Migration
  ...
  def up
		Game.destroy_all
		Game.create :team1 => Team.find(1), :team2 => Team.find(2), :round_id => 0
  	Game.create :team1 => Team.find(3), :team2 => Team.find(4), :round_id => 0
  	Game.create :team1 => Team.find(5), :team2 => Team.find(6), :round_id => 0
  	Game.create :team1 => Team.find(7), :team2 => Team.find(8), :round_id => 0
  	Game.create :team1 => Team.find(9), :team2 => Team.find(10), :round_id => 0
  	Game.create :team1 => Team.find(11), :team2 => Team.find(12), :round_id => 0
  	Game.create :team1 => Team.find(13), :team2 => Team.find(14), :round_id => 0
  	Game.create :team1 => Team.find(15), :team2 => Team.find(16), :round_id => 0
  	Game.create :team1 => Team.find(17), :team2 => Team.find(18), :round_id => 0
  	Game.create :team1 => Team.find(19), :team2 => Team.find(20), :round_id => 0
  	Game.create :team1 => Team.find(21), :team2 => Team.find(22), :round_id => 0
  	Game.create :team1 => Team.find(23), :team2 => Team.find(24), :round_id => 0
  	Game.create :team1 => Team.find(25), :team2 => Team.find(26), :round_id => 0
  	Game.create :team1 => Team.find(27), :team2 => Team.find(28), :round_id => 0
  	Game.create :team1 => Team.find(29), :team2 => Team.find(30), :round_id => 0
  	Game.create :team1 => Team.find(31), :team2 => Team.find(32), :round_id => 0
  	Game.create :team1 => Team.find(33), :team2 => Team.find(34), :round_id => 0
  	Game.create :team1 => Team.find(35), :team2 => Team.find(36), :round_id => 0
  	Game.create :team1 => Team.find(37), :team2 => Team.find(38), :round_id => 0
  	Game.create :team1 => Team.find(39), :team2 => Team.find(40), :round_id => 0
  	Game.create :team1 => Team.find(41), :team2 => Team.find(42), :round_id => 0
  	Game.create :team1 => Team.find(43), :team2 => Team.find(44), :round_id => 0
  	Game.create :team1 => Team.find(45), :team2 => Team.find(46), :round_id => 0
  	Game.create :team1 => Team.find(47), :team2 => Team.find(48), :round_id => 0
  	Game.create :team1 => Team.find(49), :team2 => Team.find(50), :round_id => 0
  	Game.create :team1 => Team.find(51), :team2 => Team.find(52), :round_id => 0
  	Game.create :team1 => Team.find(53), :team2 => Team.find(54), :round_id => 0
  	Game.create :team1 => Team.find(55), :team2 => Team.find(56), :round_id => 0
  	Game.create :team1 => Team.find(57), :team2 => Team.find(58), :round_id => 0
  	Game.create :team1 => Team.find(59), :team2 => Team.find(60), :round_id => 0
  	Game.create :team1 => Team.find(61), :team2 => Team.find(62), :round_id => 0
  	Game.create :team1 => Team.find(63), :team2 => Team.find(64), :round_id => 0
  end
